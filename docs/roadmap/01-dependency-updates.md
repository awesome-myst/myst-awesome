...
Upgrade in small, reversible pull requests rather than one lockfile rewrite. The target is Astro 7.3.2, Web Awesome 3.11.0, MyST 1.10.x, current rendering libraries, and Playwright 1.62.1; keep TypeScript on the latest 6.x line for now rather than adopting TypeScript 7 in this Astro workspace.
